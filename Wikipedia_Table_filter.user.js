...
// @version        1.1
// @include        http://*.wikipedia.tld/wiki/*
// @include        https://*.wikipedia.tld/wiki/*
// @grant          none
// @run-at         document-end
// ==/UserScript==

// Original: https://userscripts-mirror.org/scripts/show/137939

try {
    console.log("Wikipedia_Table_Filter.user.js starting");
} catch (safe_wrap_top) {}
...
try {
    console.log("Wikipedia_Table_Filter.user.js ended");
} catch (safe_wrap_top) {}
